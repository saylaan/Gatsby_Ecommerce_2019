...
class Article extends React.Component {
  render() {
    ...
    return (
      <Layout>
			<Card class="card mb-3" style={{maxWidth: 800, width:800, marginTop: 30, marginRight: 30}}>
				<Row>
					<Col sm={6}>
					...
					<Col>
						<Card.Body>
							...
							<Button style={{fontSize: "25px", alignSelf:'center'}} variant="danger">Acheter</Button>
						</Card.Body>
					</Col>
				</Row>
